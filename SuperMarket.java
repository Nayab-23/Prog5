...
public class SuperMarket 
{
	...
	public boolean cleanInventory(String message){
		...
		System.out.println("\nBefore cleanup: " + message);
		displayInventoryState("inventory before garbage collection:", true);

		boolean result = inventory.collectGarbage();

		System.out.println("\nAfter cleanup: " + message);
	...
	public static void main(String[] args) 
	{
		...
		market.displayInventoryState("State of inventory before cleanup:", true);
		market.inventory.collectGarbage();
		System.out.println("\nAfter final cleanup:");
		market.displayInventoryState("Final state of inventory after cleanup:", true);
